...
## Configuration time: Tue Mar 23 16:50:32 UTC 2021
...
cf_time='Tue Mar 23 16:50:32 UTC 2021'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg7='-Dccflags=-DDEBIAN -Wdate-time -D_FORTIFY_SOURCE=2 -g -O2 -ffile-prefix-map=/dummy/build/dir=. -flto=auto -ffat-lto-objects -fstack-protector-strong -Wformat -Werror=format-security'
config_arg8='-Dldflags= -Wl,-Bsymbolic-functions -flto=auto -Wl,-z,relro'
config_arg9='-Dlddlflags=-shared -Wl,-Bsymbolic-functions -flto=auto -Wl,-z,relro'
config_argc='41'
